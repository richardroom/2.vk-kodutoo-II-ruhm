(function() {
    ...
    Homework.prototype = {
        ...
        editEntry: function(event) {
            ...
            $(document).on("click", "#save", function(event) {
                ...
                var deadline = document.querySelector('.EditDeadline').value;
                this.jobs = JSON.parse(localStorage.jobs);
                clicked_li.parentNode.removeChild(clicked_li);
                for (var i = 0; i < this.jobs.length; i++) {
                    if (this.jobs[i].id == selected_id) {
                        this.jobs[i].title = title;
                        this.jobs[i].description = description;
                        this.jobs[i].deadline = deadline;
    ...
    Job.prototype = {
        createHtmlElement: function() {
            ...
            span_edit.addEventListener('click', Homework.instance.editEntry.bind(Homework.instance));
